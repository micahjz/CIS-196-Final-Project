...
class TutorsControllerTest < ActionController::TestCase
  ...
  test "should create tutor" do
    assert_difference('Tutor.count') do
      post :create, tutor: { email: @tutor.email, field: @tutor.field, name: @tutor.name, password_hash: @tutor.password_hash }
    end
  ...
  test "should update tutor" do
    patch :update, id: @tutor, tutor: { email: @tutor.email, field: @tutor.field, name: @tutor.name, password_hash: @tutor.password_hash }
    assert_redirected_to tutor_path(assigns(:tutor))
  end
